...
<div class="course-container">
    <div class="course-card">
        <div class="course-image">
            <img src="img/c++_fundamentals-img.jpeg" alt="Course 1">
        </div>
    ...
    <div class="course-card">
        <div class="course-image">
            <img src="img/c++_fundamentals-img.jpeg" alt="Course 2">
        </div>
        <div class="course-content">
    ...
    <div class="course-card">
        <div class="course-image">
            <img src="img/c++_fundamentals-img.jpeg" alt="Course 3">
        </div>
        <div class="course-content">
            <p class="course-title">Cybersecurity</p>
    ...
    <div class="course-card">
        <div class="course-image">
            <img src="img/c++_fundamentals-img.jpeg" alt="Course 4">
        </div>
        <div class="course-content">
            <p class="course-title">Digital Marketing</p>
    ...
    <div class="course-card">
        <div class="course-image">
            <img src="img/c++_fundamentals-img.jpeg" alt="Course 5">
        </div>
        <div class="course-content">
    ...
    <div class="course-card">
        <div class="course-image">
            <img src="img/c++_fundamentals-img.jpeg" alt="Course 6">
        </div>
        <div class="course-content">
            <p class="course-title">Project Management</p>
    ...
    <div class="course-card">
        <div class="course-image">
            <img src="https://via.placeholder.com/300x200.png?text=Course+7" alt="Course 7">
        </div>
        <div class="course-content">
            <p class="course-title">Machine Learning</p>
    ...
    <div class="course-card">
        <div class="course-image">
            <img src="https://via.placeholder.com/300x200.png?text=Course+8" alt="Course 8">
        </div>
        <div class="course-content">
            <p class="course-title">Artificial Intelligence</p>
    ...
    <div class="course-card">
        <div class="course-image">
            <img src="https://via.placeholder.com/300x200.png?text=Course+9" alt="Course 9">
        </div>
        <div class="course-content">
            <p class="course-title">Cloud Computing</p>
    ...
    <div class="course-card">
        <div class="course-image">
            <img src="https://via.placeholder.com/300x200.png?text=Course+10" alt="Course 10">
        </div>
        <div class="course-content">
            <p class="course-title">Blockchain Technology</p>
    ...
    <div class="course-card">
        <div class="course-image">
            <img src="https://via.placeholder.com/300x200.png?text=Course+11" alt="Course 11">
        </div>
        <div class="course-content">
    ...
    <div class="course-card">
        <div class="course-image">
            <img src="https://via.placeholder.com/300x200.png?text=Course+12" alt="Course 12">
        </div>
        <div class="course-content">
