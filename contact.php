    ...
    <div class="container-xxl py-5">
        <div class="container">
            <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                ...
                <h1 class="mb-5"> لأي استفسار</h1>
            </div>
            <div class="row g-4">
                <div class="col-lg-4 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                    <h5>ابقى على تواصل</h5>
                    <p class="mb-4"> نحن هنا لمساعدتك والإجابة عن جميع استفساراتك. لا تتردد في التواصل معنا عبر الطرق التالية أو عن طريق نموذج الاتصال الموجود على الصفحة
                    </p>
